...
Rcpp::List mmp_c(arma::vec target_vars, arma::mat ds, int32_t max_k,
    ...
    return calc_mmp_c(target_vars, ds, max_k, thres, method, inits, hash_on,
                      stats_kv, pvalues_kv, bws_on);
}

RcppExport SEXP Rfast2_mmp_c(SEXP target_varsSEXP, SEXP dsSEXP, SEXP max_kSEXP,
                             SEXP thresSEXP, SEXP methodSEXP, SEXP initsSEXP,
                             SEXP hash_onSEXP, SEXP stats_kvSEXP,
                             SEXP pvalues_kvSEXP, SEXP bws_onSEXP) {
    BEGIN_RCPP
    RObject __result;
    RNGScope __rngScope;
    ...
    __result = mmp_c(target_vars, ds, max_k, thres, method, inits, hash_on,
                     stats_kv, pvalues_kv, bws_on);
    return __result;
    END_RCPP
}
